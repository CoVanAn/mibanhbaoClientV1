import "../../(policy)/chinh-sach-bao-mat/PrivacyPolicy.scss";
  ...
  return (
    <div className="privacy-policy-container">
      ...
      <div className="policy-section">
        ...
        <ul>
          <li>
            ...
            phương thức thanh toán. Phổ biến nhất là thẻ tín dụng/debit, ví điện
            tử (như Momo, ZaloPay, PayPal), hoặc chuyển khoản ngân hàng.
          </li>
        </ul>
      </div>
      <div className="policy-section">
        ...
        <ul>
          <li>
            - Nếu bạn chọn thanh toán bằng thẻ, hãy nhập thông tin thẻ của bạn,
            bao gồm số thẻ, ngày hết hạn và mã bảo mật (CVV).
          </li>
          <li>
          ...
          <li>
            ...
            khoản người nhận và thực hiện chuyển khoản từ tài khoản của bạn đến
      ...
      <div className="policy-section">
        ...
        <ul>
          <li>
            - Sau khi bạn đã nhập thông tin thanh toán, hãy xem xét kỹ thông tin
            và đảm bảo chúng chính xác.
          </li>
          <li>
      ...
      <div className="policy-section">
        ...
        <ul>
          <li>
            ...
            đơn hàng hoặc giao dịch, cùng với thông tin chi tiết về đơn hàng và
      ...
      <div className="policy-section">
        ...
        <ul>
          <li>
            Theo dõi tình trạng đơn hàng hoặc giao dịch của bạn thông qua email
            xác nhận và tài khoản của bạn trên trang web cửa hàng.
          </li>
        </ul>
      </div>
      <div className="policy-section">
